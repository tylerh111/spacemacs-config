...
values."
  (setq-default
   ...
   '(
     ...
     ;; <M-m f e R> (Emacs style) to install them. <SPC h l> for package
     ;; list
     ;; ----------------------------------------------------------------
     helm
     auto-completion
...
you should place your code here."
  ...
  ;; does not open splash screen if existing file is passed as an argument
...
names an existing file."
  ...
  ;;(define-key which-key-mode-map (kbd "<f8>") 'which-key-C-h-dispatch)
  ...
  ;;(global-set-key (kbd "M-k") 'newline-line)
